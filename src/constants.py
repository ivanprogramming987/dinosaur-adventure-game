...
ELASMOSAURUS_HEALTH = 460
ELASMOSAURUS_DEFENSE = 20
ELASMOSAURUS_SPEED = 250
# elasmosaurus attacks are in "variables with functions" section

PACHYCEPHALOSAURUS_HEALTH = 250
PACHYCEPHALOSAURUS_DEFENSE = 30
PACHYCEPHALOSAURUS_SPEED = 280
PACHYCEPHALOSAURUS_ATTACKS = [Attack(30, 90, "Kick"), Attack(40, 85, "Charge"), Attack(50, 80, "Headbutt")]

ANKYLOSAURUS_HEALTH = 300
